...
const portfolioData = {
    ...
    bio: [
        "Turn slow manual workflows into AI pipelines — <strong>12.5 hours down to 15 minutes</strong>.",
        ...
        domains: [
            ...
            },
            {
                ...
                bullets: [
                    ...
                    "Designed a dual-branch CNN from scratch over raw RF signals — <strong>no pretrained backbone exists</strong>.",
    ...
    projects: [
        {
            ...
            impact: [
                "Cut batch processing from <strong>12.5 hours to ~15 minutes</strong> — 98% — and removed 75% of manual review steps by auto-approving HS codes at ≥95% confidence.",
                "Reached <strong>88–95% accuracy</strong> on 10-digit HTS classification versus 80–92% manual, so speed came with a quality gain rather than a trade-off.",
                "A role-based LangChain agent evaluates all <strong>17 Malaysian free trade agreements</strong> for the optimal duty rate, cutting an estimated $2,000–$2,500 error exposure per batch.",
                "Circuit-breaker layer guards against Ollama outages and prompt injection — the pipeline degrades safely instead of returning confident nonsense."
            ],
        ...
        },
        {
            ...
            date: "Feb — May 2026", award: "Bronze",
            ...
            impact: [
                ...
                "User testing confirmed the emotion-adaptive triggers fired correctly across scenes — validated, not just implemented."
            ],
        ...
        },
        {
            ...
            impact: [
                ...
                "Complete NGO workflow — report, live map, claim, confirmation, archive — across <strong>5 JWT-secured REST endpoints</strong>."
            ],
        ...
        },
        {
            ...
            impact: [
                ...
                "One branch reads raw IQ to preserve phase, the other an STFT spectrogram for frequency movement; attention pooling fuses both — <strong>neither alone does both jobs</strong>.",
        ...
        },
        {
            ...
            impact: [
                ...
                "Engineered <strong>confidence-governed rejection</strong> — the system declines uncertain translations rather than inventing one.",
        ...
        },
        {
            ...
            impact: [
                "Real-time on-device detection at <strong>15–30 FPS</strong> with TensorFlow Lite, so identification works with no network in a disaster zone.",
        ...
        },
        {
            ...
            impact: [
                ...
                "Built a complete multi-merchant commerce flow — grouped carts, vouchers, cards, e-wallets and FPX — plus a merchant role with its own storefront."
            ],
        ...
        },
        {
            ...
            impact: [
                ...
                "Demonstrates all four OOP pillars in a system that does something — the pillars carry real gameplay logic.",
        ...
        },
        {
            ...
            date: "May — Jul 2026", award: null,
            desc: "The complete C++ solution set for the Algorithms and Data Structures course — every weekly task, from matrix manipulation to advanced dynamic programming.",
            impact: [
    ...
    experience: [
        {
            ...
            when: "2026 — Present", type: "Leadership",
        ...
        },
        {
            ...
            when: "Mar — Jun 2026", type: "Team Lead",
        ...
        },
        {
            ...
            when: "Nov 2025 — Present", type: "Speaker",
        ...
        {
            role: "Secretary & Logistics Supervisor — ASEAN Student Forum 2026",
            org: "UTP-ASEAN Student Association",
            when: "Aug 2025 — Present", type: "Dual role",
        ...
        },
        {
            ...
            org: "UTP-ASEAN Student Association",
            when: "Mar 2025 — Present", type: "Committee",
            metrics: [],
        ...
        },
        {
            ...
            when: "Sep — Nov 2024", type: "Leadership",
        ...
        },
        {
            ...
            org: "CYBERHAX UTP",
            when: "Sep 2024 — Present", type: "Member",
        ...
        },
        {
            ...
            when: "Dec 2024 — May 2025", type: "Committee",
            metrics: [],
        ...
        {
            role: "Media Committee & Ruan Chamber Member",
            org: "UTPCO Chinese Orchestra, UTP",
            when: "Jan 2025 — Present", type: "Committee",
    ...
    certifications: [
        ...
        { emoji: "🖼️", issuer: "Google Cloud", date: "", name: "Creating Image Captioning Models", note: "Encoder–decoder architectures with attention", link: null },
    ...
    palettes: [
        ...
        { id: "teal", name: "Deep Teal & Copper", note: "Architectural. Closest in energy to the original orange.", sw: ["#08302F", "#0E4749", "#C97B4A", "#E7B08A"] },
        { id: "indigo", name: "Indigo & Violet", note: "Contemporary AI — modern without going neon.", sw: ["#1E1B4B", "#312E81", "#8B5CF6", "#C4B5FD"] },
        { id: "graphite", name: "Graphite & Cyan", note: "Engineer's terminal — minimal and precise.", sw: ["#0F172A", "#1E293B", "#0891B2", "#67E8F9"] }
    ],
